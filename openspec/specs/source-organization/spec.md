...
#### Scenario: Resolving mobile and toast hooks
- **WHEN** `Sidebar` o `Toaster` consume su hook asociado
- **THEN** lo importa desde `@/hooks/useMobile` o `@/hooks/useToast`, respectivamente
